  ...
  vosk = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchzip {
      url =
        ...
        then "https://github.com/alphacep/vosk-api/releases/download/v${finalAttrs.version}/vosk-linux-x86_64-${finalAttrs.version}.zip"
        else if stdenv.hostPlatform.system == "aarch64-linux"
        then "https://github.com/alphacep/vosk-api/releases/download/v${finalAttrs.version}/vosk-linux-aarch64-${finalAttrs.version}.zip"
        else throw "Unsupported system: ${stdenv.hostPlatform.system}";
      hash =
        if stdenv.hostPlatform.system == "x86_64-linux"
        then "sha256-ToMDbD5ooFMHU0nNlfpLynF29kkfMknBluKO5PipLFY="
        else "";
    };
...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    meta = {
      ...
      changelog = "https://github.com/mkiol/dsnote/releases/tag/v${finalAttrs.version}";
